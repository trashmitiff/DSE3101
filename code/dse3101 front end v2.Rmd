  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "accessibility",
        ...
        fluidRow(
          column(width = 6,
            box(title = "🗺️ Transport Accessibility Map", width = NULL, height = "900px",
          ...
          column(width = 6, 
            box(title = "📊 Transport Accessibility Data", width = NULL, height = "900px",
              tabsetPanel(
                tabPanel("Table",
                  textInput("subzone_search", "🔍 Search for an Area:", ""),
